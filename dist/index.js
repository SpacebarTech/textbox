...
exports.default = {
	...
	props: {
		...
		placeholder: {
			default: function _default() {
				return 'Type here to input text';
			}
		},
		label: {
			default: function _default() {
	...
	methods: {
		...
		alertBlur: function alertBlur(e) {
			this.$emit('blur', e);
		},
...
// module
exports.push([module.i, "\n.textbox {\n  transition: padding 0.5s ease;\n  position: relative;\n  cursor: pointer;\n  will-change: padding-top;\n}\n.textbox.min-padding .text-wrapper {\n    padding: 9px;\n}\n.textbox.min-padding.left-align p.label {\n    left: 9px;\n}\n.textbox.left-align p.label {\n    left: 15px;\n    transform: translateY(-50%);\n}\n.textbox.focused .text-wrapper {\n    border: 1px dashed #2E5491 !important;\n}\n.textbox.empty .text-wrapper {\n    border: 1px dashed #ebf1f7;\n}\n.textbox.show-label p.label, .textbox:hover:not(.empty) p.label {\n    top: -2px;\n    max-height: 18px;\n    opacity: 1;\n}\n.textbox.show-label .text-wrapper, .textbox:hover:not(.empty) .text-wrapper {\n    border: 1px dashed #ebf1f7;\n}\n.textbox.has-error .text-wrapper {\n    border: 1px dashed #dc3737;\n}\n.textbox.has-error p.text-error {\n    bottom: 1px;\n    max-height: 12px;\n    opacity: 1;\n}\n.textbox .text-wrapper {\n    padding: 14px;\n    border-radius: 5px;\n    border: 1px dashed transparent;\n    transition: border 0.5s ease;\n}\n.textbox .text-wrapper:hover {\n      border: 1px dashed #ebf1f7;\n}\n.textbox .text-wrapper textarea {\n      background-color: none;\n      border: none;\n      outline: none;\n      width: 100%;\n      background-color: transparent;\n      cursor: pointer;\n      display: inherit;\n}\n.textbox .text-wrapper textarea.h1 {\n        font-family: 'Trocchi', open-sans;\n        font-size: 36px;\n        line-height: 120%;\n        color: #2E5491;\n}\n.textbox .text-wrapper textarea.h2 {\n        font-family: 'Trocchi', open-sans;\n        font-size: 24px;\n        line-height: 120%;\n        color: #2E5491;\n}\n.textbox .text-wrapper textarea.h3 {\n        font-family: 'Trocchi', open-sans;\n        font-size: 18px;\n        line-height: 120%;\n        color: #2E5491;\n}\n.textbox .text-wrapper textarea.p {\n        font-family: 'Work Sans', open-sans;\n        font-size: 18px;\n        line-height: 150%;\n        color: #4a5155;\n}\n.textbox .text-wrapper textarea.p.small {\n          font-size: 14px;\n}\n.textbox p.text-error,\n  .textbox p.label {\n    position: absolute;\n    max-height: 0px;\n    overflow: hidden;\n    white-space: nowrap;\n    text-overflow: ellipsis;\n    padding: 2px;\n    background-color: white;\n    font-weight: 600;\n    letter-spacing: 2px;\n    text-transform: uppercase;\n    transition: max-height 0.5s ease, top 0.5s ease, opacity 0.5s ease;\n    opacity: 0;\n    font-size: 12px;\n    left: 50%;\n}\n.textbox p.text-error {\n    bottom: 22px;\n    color: #dc3737;\n    transform: translate(-50%, 50%);\n    padding: 0 2px;\n    display: flex;\n    align-items: center;\n}\n.textbox p.label {\n    top: 10px;\n    color: #2E5491;\n    cursor: pointer;\n    transform: translate(-50%, -50%);\n}\n", ""]);
...
var render = function() {
  ...
  return _c(
    ...
    [
      _c("p", { staticClass: "label noselect", on: { click: _vm.focus } }, [
        ...
        _c("textarea", {
          ...
          on: {
            ...
            keydown: function($event) {
              ...
              _vm.emitEvent("enter", $event)
            }
          }
        })
      ]),
      _c("p", { staticClass: "text-error" }, [_vm._v(_vm._s(_vm.displayError))])
    ]
  )
}
var staticRenderFns = []
